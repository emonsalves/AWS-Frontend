...
function Login() {
    ...
    return (
        <div className="bg-gray-300 h-full flex justify-center items-center">
            <form
                className="form md:w-2/3 lg:w-1/2 xl:w-1/3 p-2 mx-auto drop-shadow-2xl rounded-lg  bg-slate-800 pt-16 mb-16 text-gray-50 shadow-custom-light"
                onSubmit={handleSubmit}
            >
                <div className="form-header font-bold m-2 text-center">
                    <h1 className="text-3xl m-6">Bienvenido</h1>
                ...
                <div className="form-footer flex justify-between gap-2">
                    <BasicButton text="Iniciar Sesion" type="submit" color={"green"} />
                    <BasicButton text="Recuperar Contraseña" action={() => goTo("/auth/forgot-password")} color={"red"} />
                </div>
            </form>
        </div>
    );
